...
module.exports = async function(content, sourceMap) {
  ...
  if (!this.resourceQuery) {
    ...
    const rawContent = await readFile.call(this, this.resourcePath)
    const [component, tags, attrs] = parseComponent(
      this.resourcePath,
    ...
    if (tags.size) {
      content = install.call(
        ...
        'installComponents',
        content,
        getMatches.call(this, 'Tag', tags, options.match, component)
      )
    }
    ...
    if (attrs.size) {
      content = install.call(
        ...
        'installDirectives',
        content,
        getMatches.call(this, 'Attr', attrs, options.attrsMatch, component)
      )
    }
  }
